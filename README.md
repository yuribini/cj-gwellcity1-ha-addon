...
### 0.2.3 (2024-07-29)
- S6 Overlay 설치 방식 개선 및 버전 3.1.6.2로 업데이트
- 다양한 아키텍처 지원을 위한 BUILD_ARCH 변환 로직 추가
- S6 Overlay 다운로드 관련 404 Not Found 오류 해결

### 0.2.2 (2024-07-28)
- S6 Overlay 버전을 3.1.6.2로 업데이트
- S6 Overlay 다운로드 링크 수정

### 0.2.1 (2024-07-27)
- S6 Overlay 설치 오류 수정
- BUILD_ARCH 변수 추가로 다양한 아키텍처 지원 개선
